  ...
  scales: [
    {
      ...
      range: {
        callback: (scale: any, params: any) => {
          return [params.viewHeight + params.padding.top, params.padding.top];
        },
    ...
    },
    {
      ...
      range: {
        callback: (scale: any, params: any) => {
          return [params.viewWidth / 2 + params.padding.left, params.padding.left];
        },
        dependency: ['viewWidth', 'padding']
      },
      nice: true,
...

        {
          ...
          encode: {
            enter: {
              x: {
                callback: (datum: any, el: any, params: any) => {
                  return params.padding.left + params.viewWidth / 2 + params.chartPad / 2;
                },
                dependency: ['viewWidth', 'padding', 'chartPad']
              },
          ...
          encode: {
            update: {
              x: {
                // "chartWidth + chartPad"
                callback: (datum: any, el: any, params: any) => {
                  return params.padding.left + params.viewWidth / 2 + params.chartPad;
                },
                dependency: ['padding', 'viewWidth', 'chartPad']
              },
              height: {
                signal: 'viewHeight'
              }
