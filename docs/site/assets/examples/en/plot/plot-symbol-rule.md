...
category: examples
group: plot
title: plot with line and point
order: 120-4
cover: /vgrammar/preview/plot-plot-symbol-rule_0.7.6.png
---

# plot with line and point

Data sourced and demo from: [observable](https://observablehq.com/@observablehq/plot-dot-plot?intent=fork)
