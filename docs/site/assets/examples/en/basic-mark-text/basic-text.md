...
title: Basic Usage of text Element
order: 7-0
cover: /vgrammar/preview/basic-mark-text-basic-text_0.7.6.png
---

# Basic Usage of text Element

The `text` element is generally used for information display in charts, and can be bound to data or used independently.
