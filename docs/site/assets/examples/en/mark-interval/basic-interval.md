...
title: Bar Chart
order: 21-0
cover: /vgrammar/preview/mark-interval-basic-interval_0.7.6.png
---

# Bar Chart

Using `interval` to implement a bar chart makes it easier to achieve functionalities like coordinate axis transposition.

## Key Configurations

- `coordinates` creates a coordinate axis
