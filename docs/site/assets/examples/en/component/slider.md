...
order: 50-1
cover: /vgrammar/preview/component-slider_0.7.6.png
---

# Basic Scatterplot

The `Symbol` mark can be used to draw common scatterplots by mapping two numerical variables to the `x` channel and `y` channel of the `Symbol` mark, respectively.
