...
order: 0-4
cover: http://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/vgrammar/basic-mark-rect-percent-rect.png
---
...
- `transform` by using the `stack` type of `transform`, create a percentage stacked chart
