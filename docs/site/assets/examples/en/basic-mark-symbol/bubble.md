...
When mapping data to the `size` channel of the `Symbol` glyph, this type of chart is generally called a bubble chart.

## Key Configurations

- Data mapping with the `size` channel.
