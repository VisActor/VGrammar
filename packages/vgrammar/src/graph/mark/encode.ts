...
import type { BaseEncodeSpec, StateProxyEncodeSpec, IElement, MarkElementItem } from '../../types';
...
export function splitEncoderInLarge(markType: string, encoder: BaseEncodeSpec, glyphType?: string) {
